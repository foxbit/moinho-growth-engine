...
export function Button({
  ...
  return (
    <button
      ...
      onClick={onClick}
      className={`inline-flex items-center justify-center gap-2 font-medium transition-[background-color,color,border-color,box-shadow,transform] duration-200 ease-out ${VARIANTES[variant]} ${TAMANHOS[size]} ${className}`}
    >
