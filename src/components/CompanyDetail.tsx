  ...
  return (
    <div className="flex h-full flex-col rounded-2xl border border-[var(--color-border)] bg-[var(--color-bg-secondary)] shadow-xl animate-slide-up">
      ...
      <div className="flex-1 space-y-4 overflow-y-auto px-0 py-5">
        {feedback && (
          <p className="rounded-lg bg-[var(--color-success-bg)] text-[var(--color-success-ink)] px-4 py-3 text-sm font-medium animate-fade-in">
            ✓ {feedback}
          </p>
        )}
      ...
      >
        ...
        <textarea
          ...
          rows={9}
          className="w-full rounded-lg border border-[var(--color-border)] bg-[var(--color-bg-tertiary)] px-3 py-2 text-sm text-[var(--color-text-primary)] outline-none focus:border-[var(--color-primary)]"
        />
      </Modal>
