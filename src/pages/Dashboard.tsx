  ...
  return (
    <div className="space-y-4">
      <div className="flex flex-wrap items-center justify-between gap-2">
        <div>
          <h1 className="text-2xl font-bold tracking-tight sm:text-3xl">Dashboard de Inteligência Comercial</h1>
      ...
      <div className="grid grid-cols-1 gap-4 lg:grid-cols-[260px_1fr]">
        <aside
          className={`h-fit space-y-4 rounded-lg border border-[var(--color-border)] bg-[var(--color-bg-secondary)] p-4 ${
        ...
        >
          <div className="relative">
            ...
            <input
              ...
              className="w-full rounded-lg border border-[var(--color-border)] bg-[var(--color-bg-tertiary)] py-2 pl-9 pr-3 text-sm text-[var(--color-text-primary)] outline-none focus:border-[var(--color-primary)]"
            />
          </div>
              ...
              renderPopup={(company) => (
                <div className="min-w-[190px] space-y-1.5 text-sm">
                  ...
                  <div className="flex gap-2 pt-1">
                    <button
                      className="text-xs font-medium text-[var(--color-primary-ink)] hover:underline"
      ...
      {companyDetalhe && (
        <div
          className="fixed inset-0 z-50 flex justify-end bg-[var(--color-scrim)] animate-fade-in"
